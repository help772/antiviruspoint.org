...
namespace SkyVerge\WooCommerce\Cybersource\API\DataObjects;
...
{
	/**
	 * Contains client library data, retrieved from CyberSource via {@see Flex_Helper::extract_data_from_capture_context()}.
	 */
