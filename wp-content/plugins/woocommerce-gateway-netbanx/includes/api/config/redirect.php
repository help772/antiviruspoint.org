...
class Redirect extends Configuration_Abstract {
	...
	public function is_3d_enabled() {
		return 'yes' === $this->get_gateway()->get_option( 'use_layover_3ds', 'no' );
	}
	...
	/**
	 * @param \WcPaysafe\Api\Data_Sources\User_Source|\WcPaysafe\Api\Data_Sources\Order_Source $data_source
	 *
	 * @return bool
	 */
