...
<ul>
	...
	<li><label><input type="radio" name="<?php echo $option_name; ?>[trigger]" value="exit" <?php checked( $trigger, 'exit' ); ?>/><?php _e( 'when a user wants to leave the page', 'advanced-ads-layer' ); ?></label></li>
