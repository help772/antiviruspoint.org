...
( function( $, window ) {
	...
	WC_PAO.Form = ( function () {
		...
		function Form( $form ) {
			...
			// jQuery TipTip is enqueued as a dependency, but plugins / theme
			// JS optimizers can dequeue or fail to load it. Guard the call so
			// missing TipTip degrades gracefully instead of throwing
			// "$(...).tipTip is not a function" on product pages.
