...
class WC_Product_Addons_Cart_Ajax {
	...
	public function __construct() {
		// Dismiss notices.
		add_action( 'wp_ajax_woocommerce_dismiss_addons_notice', array( $this, 'dismiss_notice' ) );
	...
	public static function dismiss_notice() {
		...
		if ( ! check_ajax_referer( 'wc_pao_dismiss_notice_nonce', 'security', false ) ) {
		...
		$dismissed = WC_PAO_Admin_Notices::dismiss_notice( wc_clean( $_POST['notice'] ) ); // phpcs:ignore WordPress.Security.ValidatedSanitizedInput.MissingUnslash
