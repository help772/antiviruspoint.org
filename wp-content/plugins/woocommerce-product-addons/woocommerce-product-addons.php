...
function woocommerce_product_addons_init() {
	...
	if ( ! class_exists( 'WC_Product_Addons' ) ) :
		...
		define( 'WC_PRODUCT_ADDONS_VERSION', '8.3.1' ); // WRCS: DEFINED_VERSION.
		...
		class WC_Product_Addons {
			...
			public function init() {
				...
				require_once __DIR__ . '/includes/class-wc-product-addons-abilities.php';
				WC_Product_Addons_Abilities::init();
