...
/**
 * RoyalMail_Regular_Parcelforce_Express_10 class.
 */
class RoyalMail_Regular_Parcelforce_Express_10 extends Parcelforce_UK_Rate {
	/**
	...
	public function get_rate_slug(): string {
		return Services::PARCELFORCE_EXPRESS_10;
	}
}
