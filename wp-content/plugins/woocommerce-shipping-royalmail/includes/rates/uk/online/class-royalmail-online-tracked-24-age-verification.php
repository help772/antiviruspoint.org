<?php
/**
 * Online Tracked 24 Age Verification rate.
 *
...
/**
 * RoyalMail_Online_Tracked_24_Age_Verification class.
 */
class RoyalMail_Online_Tracked_24_Age_Verification extends RoyalMail_Rate {
	/**
	...
	public function get_rate_slug(): string {
		return Services::TRACKED_24_AGE_VERIFICATION;
	}
	 ...
	 *
	 * @return array{ 'tracked-24-age-verification': float }|false|null
	 */
	public function get_quotes( $items, $packing_method, $country_code, $boxes = array(), $instance_id = 0 ) {
		 ...
		 * @since 3.2.4
		 */
		$tube_packages           = apply_filters( 'woocommerce_shipping_royal_mail_tube_enabled', true, $instance_id, Services::TRACKED_24_AGE_VERIFICATION, $country_code, $packing_method ) ? $this->get_tube_packages( $items, $country_code, $packing_method ) : array();
