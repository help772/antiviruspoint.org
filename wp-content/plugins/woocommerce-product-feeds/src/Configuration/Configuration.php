...
class Configuration {
 ...
 [for Shopping Actions integration]',
				...
				'return_policy_label'                 => [
					...
					'full_desc'       => __( 'use this to apply a non-default return policy to a product or group of products. ', 'woocommerce_gpf' ),
					'can_default'     => true,
					'callback'        => 'render_textfield',
					'can_prepopulate' => true,
					'feed_types'      => [ 'google' ],
				...
				'video_link'                          => [
					'desc'            => __( 'Video link(s)', 'woocommerce_gpf' ),
					'full_desc'       => __( 'Link to videos of the product. You can provide up to 10 links.', 'woocommerce_gpf' ),
					'feed_types'      => [ 'google' ],
					'can_prepopulate' => true,
					'callback'        => 'render_video_link',
					'ui_group'        => 'advanced',
				],
			]
		);
