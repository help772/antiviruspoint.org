...
use Ademti\WoocommerceProductFeeds\Admin\BlueprintHandler;
...
class Main {
	...
	// Dependencies.
	protected BlueprintHandler $blueprint_handler;
	 ...
	 * @param  BlueprintHandler  $blueprint_handler
	 */
	public function __construct(
		...
		BlueprintHandler $blueprint_handler
	) {
		...
		$this->blueprint_handler    = $blueprint_handler;
	}
