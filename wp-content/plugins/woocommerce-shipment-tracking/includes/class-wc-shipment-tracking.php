...
class WC_Shipment_Tracking {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_translations_updates_for_' . basename( WC_SHIPMENT_TRACKING_FILE, '.php' ), '__return_true' );
	...
	private function includes() {
		...
		require_once $this->plugin_dir . '/includes/class-wc-shipment-tracking-abilities.php';
		WC_Shipment_Tracking_Abilities::init();
	...
	public function load_plugin_textdomain() {
		load_plugin_textdomain( 'woocommerce-shipment-tracking', false, plugin_basename( $this->plugin_dir ) . '/languages/' );
	}
