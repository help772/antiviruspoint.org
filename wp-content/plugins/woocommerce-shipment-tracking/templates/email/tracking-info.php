	...
	<table class="td" cellspacing="0" cellpadding="6" style="width: 100%;" border="1">
		...
		<thead>
			<tr>
				...
				<th class="order-actions" scope="col" class="td" style="text-align: left; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; color: #737373; border: 1px solid #e4e4e4; padding: 12px;"><?php esc_html_e( 'Tracking link', 'woocommerce-shipment-tracking' ); ?></th>
			</tr>
		</thead>
