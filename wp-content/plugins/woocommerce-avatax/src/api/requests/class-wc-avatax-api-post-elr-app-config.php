 ...
 * @since 3.0.0
 */
class WC_AvaTax_API_Post_Elr_App_Config extends WC_AvaTax_Elr_API_Request {
	...
	public function __construct($type) {
		...
		$this->path = "/active-applications/".$application_id."/configs/" . $website_id."_elr";
		$this->method = $type;
        ...
        if(wc_avatax()->has_elr_api_credentials_set() && wc_avatax()->check_elr_api())
		{
			...
			$data->avaTaxCompany = get_option('wc_avatax_elr_company', '');
