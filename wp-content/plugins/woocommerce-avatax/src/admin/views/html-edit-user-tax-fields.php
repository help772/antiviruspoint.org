...
<table class="form-table" aria-describedby="lbl_wc_avatax_user_exemption">
	<tr>
		<th>
			<label id="lbl_wc_avatax_user_exemption" for="wc_avatax_user_exemption">
				<?php esc_html_e('Tax Exemption', 'woocommerce-avatax'); ?>
			</label>
		</th>
		<td>
