...
= 2.0.3 =
- Fix: allow AMP placement condition to be saved again

= 2.0.2 =
- Fix: correct the license handling

= 2.0.1 =
- Fix: prevent a fatal error on activation
...
= 1.12.4 =
- Improvement: update Arabic, Danish, German, German (formal), German (Austria, Switzerland), Greek, Italian, Slovenian translations
