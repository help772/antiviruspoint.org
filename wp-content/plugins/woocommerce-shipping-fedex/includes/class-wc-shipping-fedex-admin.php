	...
	public function product_options() {
		woocommerce_wp_checkbox(
			array(
				...
				'description' => __( 'Add lift service at delivery. Requires FedEx Freight to be enabled.', 'woocommerce-shipping-fedex' ),
				'desc_tip'    => true,
			)
		);
		...
		woocommerce_wp_checkbox(
			array(
				...
				'description' => __( 'Add lift service at pickup. Requires FedEx Freight to be enabled.', 'woocommerce-shipping-fedex' ),
				'desc_tip'    => true,
			)
		);
	}
