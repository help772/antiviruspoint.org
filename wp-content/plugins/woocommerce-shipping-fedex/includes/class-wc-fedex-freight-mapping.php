...
class WC_Fedex_Freight_Mapping {
	...
	public function __construct() {
		$this->classes = include WC_SHIPPING_FEDEX_ABSPATH . 'includes/data/data-freight-classes.php';
	...
	public function get_shipping_classes( $classes ) {
		foreach ( $classes as $class ) {
			$class->fedex_freight_class         = get_term_meta( $class->term_id, 'fedex_freight_class', true );
