		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					'Click-to-Chat PRO Plugin requires the following plugin: %1$s.',
					'Click-to-Chat PRO Plugin requires the following plugins: %1$s.',
					'tgmpa'
				),
				'notice_can_install_recommended'  => _n_noop(
					'Click-to-Chat PRO Plugin recommends the following plugin: %1$s.',
					'Click-to-Chat PRO Plugin recommends the following plugins: %1$s.',
					'tgmpa'
				),
				'notice_ask_to_update'            => _n_noop(
					'The following plugin needs to be updated to its latest version to ensure maximum compatibility with Click-to-Chat PRO Plugin: %1$s.',
					'The following plugins need to be updated to their latest version to ensure maximum compatibility with Click-to-Chat PRO Plugin: %1$s.',
					'tgmpa'
				),
