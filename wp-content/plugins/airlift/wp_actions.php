	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, '6f383ee6e457108da65100109a11c334', '5a37f3ad76ab9b170aae98354dd62815');
		ALAccount::updateApiPublicKey($this->settings, '6f383ee6e457108da65100109a11c334');
			}
