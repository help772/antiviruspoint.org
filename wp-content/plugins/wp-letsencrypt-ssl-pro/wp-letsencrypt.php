 ...
 *
 * @fs_premium_only /classes/le-autorenew.php, /classes/le-pleskapi.php, /classes/le-cron.php, /classes/le-gdaddy-dns.php, /classes/le-spmode.php, /classes/le-cpapi.php, /classes/cPanel, /languages/, /admin/scss, /admin/app, README_License.txt
 * 
 */
/**
...
if ( wple_fs()->can_use_premium_code__premium_only() ) {
     ...
     * @since 7.2.0
     */
    require_once WPLE_DIR . 'classes/le-pleskapi.php';
    new WPLE_PleskAPI();
}
