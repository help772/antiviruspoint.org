...
class WPLE_SubAdmin extends WPLE_Admin_Page
{
    ...
    public function wple_register_admin_pages()
    {
        ...
        //since 7.8.2
        add_submenu_page('options.php', 'Setup Wizard', __('Setup Wizard', 'wp-letsencrypt-ssl'), 'manage_options', 'wp_encryption_setup_wizard', [$this, 'wple_setup_wizard_page']);
    ...
    public function wple_update_settings()
    {
        ...
        $allowed = array('mixed_content_fixer', 'hsts', 'security_headers', 'upgrade_insecure', 'httponly_cookies', 'ssl_monitoring', 'xxss', 'xcontenttype', 'xframe', 'referrer', 'vulnerability_scan', 'daily_vulnerability_scan', 'notify_vulnerability_scan', 'autofix_vulnerability_scan');
