...
class WPLE_Admin
{
    public function __construct()
    {
        ...
        if (FALSE !== get_option('wple_mixed_issues') && FALSE === get_option('wple_mixed_issues_disabled')) { //since 5.3.12
    ...
    public function wple_menu_page()
    {
        ...
        } else if (version_compare(get_option('wple_version'), '7.8.1', '<=')) {
            delete_option('wple_plan_choose');
            update_option('wple_version', WPLE_PLUGIN_VER);
        }
...
?>
        ...
        <h4 class="pricing-intro-subhead">Purchase once and use for lifetime - Trusted Globally by <b>250,000+</b> WordPress Users (Looking for <a href="<?php echo esc_url_raw(admin_url('/admin.php?page=wp_encryption&gopro=3')); ?>">Annual</a> | <a href="<?php echo esc_url_raw(admin_url('/admin.php?page=wp_encryption&gopro=2')); ?>">Unlimited Sites License?</a>)</h4>
        ...
        <div id="quick-pricing-table">
            <div class="free-pricing-col wplepricingcol">
                ...
                <div class="pricing-btn-block">
                    <a href="<?php echo esc_url_raw(admin_url('/admin.php?page=wp_encryption&gofree=1')); ?>" class="pricingbtn free">Select Plan</a>
                </div>
            </div>
            ...
            <div class="pro-pricing-col wplepricingcol proplan">
                ...
                <div class="pricing-btn-block">
                    <a href="<?php echo esc_url_raw(admin_url('/admin.php?page=wp_encryption&gopro=1')); ?>" class="pricingbtn free">Select Plan</a>
                </div>
            </div>
    ...
    ?>
        ...
        <div id="quick-pricing-table" class="non-cpanel-plans">
            ...
            <div class="pro-pricing-col wplepricingcol firewallplan">
                ...
                <div class="pricing-btn-block">
                    <a href="<?php echo esc_url_raw(admin_url('/admin.php?page=wp_encryption&gofirewall=1')); ?>" class="pricingbtn free">Select Plan</a>
                </div>
            </div>
...
<?php
    ...
    public function wple_renewal_due__premium_only()
    {
        ...
        if ($now > $last5days) {
            ...
            if ($now > strtotime($lic->expiration)) {
                $expiring = 'EXPIRED';
            }
