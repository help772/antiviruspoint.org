...
if ( ! class_exists( 'YITH_WCAS' ) ) {
	...
	class YITH_WCAS {
		...
		public function load_compatibility() {
			...
			// YITH Ajax Filter.
			if ( defined( 'YITH_WCAN_PREMIUM_INIT' ) && ! class_exists( 'YITH_WCAS_Ajax_Filter_Support' ) ) {
				require_once YITH_WCAS_INC . 'compatibility/class-yith-wcas-ajax-filter-support.php';
				YITH_WCAS_Ajax_Filter_Support::get_instance();
			}
