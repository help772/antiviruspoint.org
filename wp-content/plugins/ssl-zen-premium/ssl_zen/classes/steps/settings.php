...
if (!function_exists('ssl_zen_debug_container')) {
    ...
    function ssl_zen_debug_container($tabsToShow, $activeTab)
    {
        if (sz_fs()->is_plan('cdn', true) && in_array('debug', $tabsToShow, true)) {
            ...
            <div class="row ssl-zen-settings-container debug-container">
                ...
                <div class="col-md-12">
                    <div class="message-container-2">
                        ...
                        if ($url) {
                            echo sprintf('<div class="message success">%s <i class="copy-clipboard" title="%s" data-clipboard-text="%s"></i></div><div class="message-container"></div>', esc_url($url), __('Copy', 'ssl-zen'), esc_url($url));
                        }
                        ?>
                    </div>
                    ...
                    <a
                        ...
                        data-hidden-value="<?php echo esc_attr(!$detectedStackPathIp ? '2' : '1'); ?>"
                    >
            ...
            ?>
            <div class="row ssl-zen-settings-container debug-container <?php echo esc_attr($extraClass); ?>">
                <div class="col-md-9">
                    <ul class="mb-4">
                        <li class="d-flex mb-4 line">
                            <div>
                ...
                <div class="col-md-12">
                    <div class="table">
                        ...
                        <div class="body p-0">
                            <textarea class="border-0 w-100 p-4"><?php echo esc_html($debugLog); ?></textarea>
                        </div>

                        <a
                            href="<?php echo admin_url('admin.php?page=ssl_zen&tab=settings&download=debug_log'); ?>"
