                ...
                <div class="media">
                    <div class="media-left">
                        <img class="media-object"
                             src="<?php echo esc_url( SSL_ZEN_URL ); ?>img/<?php echo $image; ?>.svg"
                             alt="encrypt">
                    </div>
        ...
        <div class="row align-items-center p-4">
            ...
            <div class="col-sm-9 pt-4 pb-4">
                ...
                <span class="text mb-3">
                    <?php $urlInfo = parse_url( get_site_url() );
				...
				<?php if ( ! ssl_zen_helper::checkWWWSubDomainExistence( $host ) && ! sz_fs()->is_plan( 'cdn', true ) ) : ?>
                    <div class="checkbox checkbox-success checkbox-circle">
                        <input type="checkbox" class="styled" name="include_www" id="include_www"
                               value="1" <?php echo esc_attr( get_option( 'ssl_zen_include_wwww', '' ) == '1' ? 'checked="checked"' : '' ); ?> >
                        <label for="include_www">
                            ...
                            <a href="#"
                               ...
                               title="<?php _e( 'By default, we generate SSL certificate only for domain.com. If user enters www.domain.com your website will show a not secure warning. Check this box to create a certificate for www.domain.com too. Make sure you have a CNAME or A record added for www in your domain panel.', 'ssl-zen' ); ?>">
                                <img src="<?php echo esc_url( SSL_ZEN_URL ); ?>img/imp.svg" alt="">
                            </a>
                        </label>
                    </div>
				<?php endif; ?>
			...
			if ( sz_fs()->is_plan( 'cdn', true ) ) {
                ...
                <div class="col-sm-9 pt-4 pb-4">
                    ...
                    <br>
                    <span class="text mb-3">
                            <?php echo esc_html( $apiResponse['ip'] ); ?>
                                </span>
                    <input type="hidden" name="ip_address"
                           id="ip_address"
                           value="<?php echo esc_html( $apiResponse['ip'] ); ?>">
                ...
                <div class="col-sm-9 pt-4 pb-4">
                    ...
                    <input type="email" name="email" id="email"
                           ...
                           value="<?php echo esc_attr( get_option( 'ssl_zen_email' ) ); ?>"
                           required>
                </div>
				<?php
			}
                    ...
                    <div class="col-sm-9 pt-4 pb-4">
                        ...
                        <div style="min-height: 63px">
                            <input type="text"
                                   ...
                                   value="<?php echo esc_attr( get_option( 'ssl_zen_cpanel_username' ) ); ?>"
                                   required>
                        </div>
                        ...
                        <input type="password"
                               ...
                               value="<?php echo esc_attr( get_option( 'ssl_zen_cpanel_password' ) ); ?>"
                               required>
                    </div>
				<?php
				endif;
