		...
		<tbody>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Required.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('i.e. for "12-AB-34-CD" the character map is <kbd>ABCD1234</kbd>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Required.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('i.e. for "12-AB-34-CD" the number of chunks is <kbd>4</kbd>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Required.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('i.e. for "12-AB-34-CD" the chunk length is <kbd>2</kbd>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						...
						<span><?php esc_html_e('i.e. for "12-AB-34-CD" the separator is <kbd>-</kbd>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Optional.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('Adds a word at the start (separator <b>not</b> included), i.e. <kbd><b>PRE-</b>12-AB-34-CD</kbd>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Optional.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('Adds a word at the end (separator <b>not</b> included), i.e. <kbd>12-AB-34-CD<b>-SUF</b></kbd>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
