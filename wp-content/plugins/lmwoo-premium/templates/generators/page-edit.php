		...
		<tbody>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Required.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('The characters which will be used for generating a license key, i.e. for <code>12-AB-34-CD</code> the character map is <code>ABCD1234</code>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Required.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('The number of separated character sets, i.e. for <code>12-AB-34-CD</code> the number of chunks is <code>4</code>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Required.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('The character length of an individual chunk, i.e. for <code>12-AB-34-CD</code> the chunk length is <code>2</code>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						...
						<span><?php esc_html_e('The special character separating the individual chunks, i.e. for <code>12-AB-34-CD</code> the separator is <code>-</code>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Optional.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('Adds a character set at the start of a license key (separator <b>not</b> included), i.e. for <code>PRE-12-AB-34-CD</code> the prefix is <code>PRE-</code>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
			...
			<tr scope="row">
				...
				<td>
					...
					<p class="description" id="tagline-description">
						<b><?php esc_html_e('Optional.', 'license-manager-for-woocommerce'); ?></b>
						<span><?php esc_html_e('Adds a character set at the end of a license key (separator <b>not</b> included), i.e. for <code>12-AB-34-CD-SUF</code> the suffix is <code>-SUF</code>.', 'license-manager-for-woocommerce'); ?></span>
					</p>
				</td>
			</tr>
