...
/**
 * Class ApplicationReleaseMeta
 *
 * @package LicenseManagerForWooCommercePro\Database\Models\Resources
 */
class ApplicationReleaseMeta extends AbstractResourceModel implements ModelInterface {
	...
	**/
	 ...
	 * @var int
	**/
	protected $application_release_id;
	...
	**/
	...
	/**
	 * ApplicationReleaseMeta constructor.
	 *
	 * @param stdClass $meta
	**/
	public function __construct( $meta ) {
		...
		$this->application_release_id = (int) $meta->release_id;
	...
	**/
	...
	/**
	 * Get application release id
	 * 
	 * @return int
	**/
	public function getApplicationReleaseId() {
		return $this->application_release_id;
	}

	/**
	 * Set application release id
	 * 
	 * @param int $id
	**/
	public function setApplicationReleaseId( $id ) {
		$this->application_release_id = $id;
	}
