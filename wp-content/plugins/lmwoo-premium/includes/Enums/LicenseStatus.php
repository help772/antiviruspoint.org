...
abstract class LicenseStatus {
	 ...
	 * @return string
	 */
	public static function toHtmlExpired( $license, $args = array() ) {

		$args     = wp_parse_args( $args, array( 'style' => 'normal', 'text' => '' ) );
		$cssClass = 'normal' === $args['style']   ? 'lmfwc-status' : 'lmfwc-status-' . $args['style'];
	 ...
	 */
	public static function toHtml( $license, $args = array() ) {
	 ...
	 * @return string
	 */
	public static function statusToHtml( $status, $args = array() ) {
