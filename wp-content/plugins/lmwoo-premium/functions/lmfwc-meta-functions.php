...
function lmfwc_add_license_meta( $licenseId, $metaKey, $metaValue ) {
	...
	/**
	 *  LicenseMetaResourceRepository insert license
	 * 
	 * @var LicenseResourceRepository $licenseMeta 
	**/
...
function lmfwc_get_license_meta( $licenseId, $metaKey, $single = false ) {
	...
	if ($single) {
		/**
		 *  LicenseMetaResourceRepository find license
		 * 
		 * @var LicenseMetaResourceRepository $licenseMeta 
		**/
