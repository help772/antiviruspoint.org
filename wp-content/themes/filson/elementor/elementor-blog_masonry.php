...
class hexwp_element_blog_masonry extends \Elementor\Widget_Base {

 
	public function get_name() {
		return hexwp_slug().'_blog_masonry';
	}

 
	public function get_title() {
		return  __( 'Blog Masonry', 'hexwp' );
	}
	...
	protected function register_controls_general(){
 		include  hexwp_PATH . '/elementor/blog/elementor-blog-masonry-general.php';  
 	}
	
	protected function register_controls_layout(){
 		include hexwp_PATH . '/elementor/blog/elementor-blog-masonry-layout.php';  
 	}
		...
		$args['key']= $this->get_id();
 		...
 		$args['option'] = array(
  		 ...
  		 <div class="hw-elementor-<?php echo esc_attr($this->get_id());?>">      
			...
			<?php echo hexwp_blog_masonry_config($args,true);?>
		  
 			<?php if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {?>
                 <div class="hw-elementor-script"> 
                 
						<script src='<?php echo  hexwp_DIR . '/js/lib/masonry.min.js'?>' id='hexwp-masonry-js'></script>    
