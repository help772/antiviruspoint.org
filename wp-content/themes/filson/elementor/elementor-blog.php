...
class hexwp_element_blog extends \Elementor\Widget_Base {

 
	public function get_name() {
		return hexwp_slug().'_blog';
	}

 
	public function get_title() {
		return __( 'Blog', 'hexwp' );
	}
	...
	protected function register_controls_general(){
 		include  hexwp_PATH . '/elementor/blog/elementor-blog-general.php';  
 	}
	
	protected function register_controls_layout(){
 		include hexwp_PATH . '/elementor/blog/elementor-blog-layout.php';  
 	}
		...
		$args['key']= $this->get_id();
 		...
 		$args['option'] = array(
			...
			******************************************************************************************************************/
				...
				'excerpt_2' 					=> hexwp_settings($option,'excerpt_2'),
			...
			******************************************************************************************************************/
				...
				'image_width_2'				=> hexwp_settings($option,'image_width_2'),
