...
$font_typicon=hexwp_option('font_typicon');	
 function hexwp_typicon( $element) {

$hexwp_icons =array(
	
	__('Typcn','hexwp')=> array(
			...
			'typcn-arrow-forwahw-outline' => 'arrow-forwahw-outline',
			...
			'typcn-media-fast-forwahw-outline' => 'media-fast-forwahw-outline',
			...
			'typcn-media-recohw-outline' => 'media-recohw-outline',
	...
	$element['Typcn']=$hexwp_icons;
    return $element;
}
add_filter('hexwp_icon_element', 'hexwp_typicon');
