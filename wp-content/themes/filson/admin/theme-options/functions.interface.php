...
function optionsframework_add_admin() {
	 ...
	 $of_page =add_submenu_page(
        'hexwp_theme', // parent slug
        __('Theme Options', 'hexwp'), 
        __('Theme Options', 'hexwp'), 
		'edit_theme_options',
		'optionsframework',
 ...
 */
 function optionsframework_options_page(){
	...
	*/	
	...
	include_once hexwp_PATH . '/admin/theme-options/options.php' ;
...
function of_style_only(){
	...
	//filson Edit
	wp_enqueue_style('admin-style',  hexwp_DIR .'/admin/assets/css/admin-style.css');
 	//wp_enqueue_style('color-picker', ADMIN_DIR . 'assets/css/colorpicker.css');
	wp_enqueue_style('jquery-ui-custom-admin',  hexwp_DIR .'/admin/assets/css/jquery-ui-custom.css');
...
function of_load_only() 
{
	...
	//filson Eite
	wp_enqueue_script('jquery-input-mask', hexwp_DIR .'/admin/assets/js/jquery.maskedinput-1.2.2.js', array( 'jquery' ));
	wp_enqueue_script('tipsy',  hexwp_DIR .'/admin/assets/js/jquery.tipsy.js', array( 'jquery' ));
	//wp_enqueue_script('color-picker', ADMIN_DIR .'assets/js/colorpicker.js', array('jquery'));
//	wp_enqueue_script('cookie',  hexwp_DIR .'/admin/assets/js/cookie.js', 'jquery');

	wp_register_script('smof', hexwp_DIR .'/admin/assets/js/smof.js', array( 'jquery' ),'1.3');

	$array = array( 'ajaxurl' => admin_url( 'admin-ajax.php'  ));
	
 	
	wp_localize_script( 'smof', 'filson_js', $array  );	
 	wp_enqueue_script( 'smof' );

	
 	//wp_enqueue_script('predefined', hexwp_DIR .'/admin/assets/js/predefined.js', array( 'jquery' ));
