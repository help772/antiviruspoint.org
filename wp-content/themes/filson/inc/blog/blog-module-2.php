...
*//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function hexwp_blog_module_2($option,$class='',$excerpt_2 =false,$ratio_2=false,$image_size_2=false){
	global $post;
    ...
    <div class="hw-item hw-module-2  <?php echo esc_attr($class.' '.$post_thumbnail.' '.$is_sticky);?>">
