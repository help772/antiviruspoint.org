...
*//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
function hexwp_product_module_2($option,$class='',$excerpt_2 =false,$ratio_2=false,$image_size_2=false){
	global $post,$product;
  ...
  ?>
	<div class="hw-item hw-module-2 <?php echo esc_attr($class.' '.$post_thumbnail);?>">
	<div class="hw-post-product product" >
       
  					
		<?php 
		
		hexwp_product_thumb ($option,true);?>
