...
<head>
    ...
    <link rel="stylesheet" href="<?php echo hexwp_DIR?>/style.css?41455" type="text/css" />
    <link rel="stylesheet" href="<?php echo hexwp_DIR?>/css/woocommerce.css" type="text/css" />
	...
	$item_css='';
	$res_css='';
 	include hexwp_PATH . '/custom-css/lib/font-family-css.php';
 	include hexwp_PATH . '/custom-css/lib/body-style-css.php';
 	include hexwp_PATH . '/custom-css/lib/post-css.php';
 	$css.=':root{'.$item_css.'}';
 	$css.='body{'.hexwp_custom_var('--hw-fn-fm',hexwp_option('body_font_family')).'}';
  
 	//**Font Start
	$css.='body  {';
				$css.='font-family:var(--hw-fn-fm), arial,roboto, sans-serif;';
	$css.='}';		
...
table.compare-list td,table.compare-list tbody th{
	padding:10px 15px;
}
body .hw-price {
  float: none;
}
.compare-list .hw-price{
	text-align:center;
}
.compare-list .hw-price .screen-reader-text {
  margin: 0px 5px;
